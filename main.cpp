...
InitGraphics( )
{
	...
	glutIdleFunc( Animate );
	 ...
	 for(int i = 0; i < NUMPARTICLES; i++){
        ...
        p.vy0 = Ranf(1., 5.); p.vx0 = Ranf(-.25, .25); p.vz0 = Ranf(-.25, .25);
        p.r0 = Ranf(0.,1.); p.g0 = Ranf(0.,1.); p.b0 = Ranf(0.,1.);
        p.t0 = Ranf(0.1f, 100.f); p.t1 = p.t0 + Ranf(1.f, 10.f);
